...
<head>
    ...
    <title>Sajilo Yatra | Admin Edit Vehicles</title>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <select class="selectpicker" name="seatingcapacity" required>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4">
                                                    Photos 1 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
                                                    <a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Change Photos 1</a>
                                                </div>
                                                <div class="col-sm-4">
                                                    Photos 2 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
                                                    <a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Change Photos 2</a>
                                                </div>
                                                <div class="col-sm-4">
                                                    Photos 3 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
                                                    <a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">Change Photos 3</a>
                                                </div>
                                            </div>
                                            <div class="hr-dashed"></div>
											<div class="form-group">
