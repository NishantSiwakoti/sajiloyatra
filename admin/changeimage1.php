...
<head>
    ...
    <title>Sajilo Yatra | Update Photos</title>
    ...
    <div class="ts-main-content">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">Vehicle Photos</h2>
                        <div class="row">
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Vehicle Photos Details</div>
                                    <div class="panel-body">
                                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Upload a new photo<span style="color:red">*</span></label>
                                                <div class="col-sm-8">
