...
<title>Sajilo Yatra - My Booking</title>
<!--Bootstrap -->
...
foreach($results as $result)
{
    ...
    $totalAmount = $result->totaldays * $result->PricePerDay;
?>  

<li>
    <h4 style="color:red">Your booking number: <?php echo htmlentities($result->BookingNumber);?></h4>
    ...
    <form action = "<?php echo $epay_url?>" method="POST">
        <!-- Pass dynamically calculated total amount to eSewa payment form -->
        ...
        <input value="Confirmed, Pay now" type="submit" class="btn btn-primary">           
    </form>
...
<table>
  ...
  <tr>
    ...
    <th><?php echo htmlentities($totalAmount); ?></th>
  </tr>
</table>
<hr />
<?php }}  else { ?>
    <h5 text-align="center" style="color:red">No booking yet</h5>
<?php } ?>
